const en = {
  ...
  projects: {
    ...
    description:
      "Internal systems, monitoring dashboards, and operational platforms built for real-world business workflows.",
  ...
  about: {
    ...
    card1: {
      ...
      title: "1+",
      description: "Years developing internal systems and operational tools.",
    },

    card2: {
      badge: "Systems Built",
      title: "8+",
      description: "Internal platforms and business systems developed.",
    },
  ...
  approach: {
    ...
    title:
      "Building systems that are practical to use, reliable to operate, and easier to maintain over time.",
